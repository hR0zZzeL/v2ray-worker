...
## Deploy 
 ...
 3. Go to this forked repo and set secrets with name `0d56cb72288b4dc7a6074adb441fc3cd` and fill with KV settings ID
 4. Edit this `README.md` file, then find and replace this button url bellow with yours `https://github.com/vfarid/v2ray-worker` then save it.
